...
export default class GUI {
    ...
    setupGUI() {
        ...
        starsFolder.add(Config.shootingStars, 'spawnRate', 0, 0.2).name('Spawn Rate')
        ...
        starsFolder.add(Config.shootingStars, 'trailLength', 1, 50).name('Trail Length')

        const starsLightFolder = starsFolder.addFolder('Light Settings')
        starsLightFolder.add(Config.shootingStars.lightIntensity, 'min', 0, 500).name('Min Intensity')
        starsLightFolder.add(Config.shootingStars.lightIntensity, 'max', 0, 500).name('Max Intensity')
        starsLightFolder.add(Config.shootingStars, 'lightRange', 100, 10000).name('Light Range')

        const starsFadeFolder = starsFolder.addFolder('Fade Settings')
        starsFadeFolder.add(Config.shootingStars.fadeSpeed, 'min', 0.001, 0.05).name('Min Fade Speed')
        starsFadeFolder.add(Config.shootingStars.fadeSpeed, 'max', 0.001, 0.05).name('Max Fade Speed')
        ...
        rainFadeFolder.add(Config.rain.fadeSpeed, 'max', 0.001, 0.05).name('Max Fade Speed')
    }
} 